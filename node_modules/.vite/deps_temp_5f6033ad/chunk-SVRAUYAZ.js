...
__export(core_exports, {
  ...
  ɵescapeTransferStateContent: () => escapeTransferStateContent,
  ...
  ɵunescapeTransferStateContent: () => unescapeTransferStateContent,
...
function refreshContainsDirtyView(lView) {
  ...
  if (components !== null) {
    for (let i = 0; i < components.length; i++) {
      ...
      if (viewAttachedToChangeDetector(componentView) && componentView[DESCENDANT_VIEWS_TO_REFRESH] > 0) {
        refreshContainsDirtyView(componentView);
      }
    }
  }
...
var R3TemplateRef = class TemplateRef2 extends ViewEngineTemplateRef {
  ...
  createEmbeddedViewImpl(context2, injector, hydrationInfo) {
    ...
    const embeddedLView = createLView(this._declarationLView, embeddedTView, context2, 16, null, embeddedTView.declTNode, null, null, null, injector || null, hydrationInfo || null);
...
function locateOrCreateAnchorNode(lContainer, hostLView, hostTNode, slotValue) {
  ...
  const isNodeCreationMode = !hydrationInfo || isInSkipHydrationBlock(hostTNode) || isDisconnectedNode$1(hydrationInfo, noOffsetIndex);
  if (isNodeCreationMode) {
...
function annotateHostElementForHydration(element, lView, context2) {
  const renderer = lView[RENDERER];
  if ((lView[FLAGS] & 32) === 32 || componentUsesShadowDomEncapsulation(lView)) {
...
var _InitialRenderPendingTasks = class {
  ...
  constructor() {
    this.taskId = 0;
    this.collection = /* @__PURE__ */ new Set();
...
function printHydrationStats(injector) {
  ...
  const message = `Angular hydrated ${ngDevMode.hydratedComponents} component(s) and ${ngDevMode.hydratedNodes} node(s), ${ngDevMode.componentsSkippedHydration} component(s) were skipped. Note: this feature is in Developer Preview mode. Learn more at https://next.angular.io/guide/hydration.`;
...
export {
  ...
  escapeTransferStateContent,
  unescapeTransferStateContent,
  makeStateKey,
  TransferState,
  ComponentRef$1,
  ComponentFactory$1,
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-SVRAUYAZ.js.map
